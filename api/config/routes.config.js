...
router.patch('/streams/:id', secure.isAuthenticated, streamsMid.isOwnedByUser, streams.update);
router.delete('/streams/:id', secure.isAuthenticated, streamsMid.isOwnedByUser, streams.delete);
